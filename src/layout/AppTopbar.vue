...
<template>
    <div class="layout-topbar border-b">
        <div class="layout-topbar-logo-container">
            ...
            <router-link to="/" class="layout-topbar-logo py-3">
                <img width="52" src="/src/assets/images/san_jose_batangas_logo.jpg" alt="" class="rounded-full" />
                ...
                <span class="py-1 w-1/2 text-nowrap">San Jose, Batangas</span>
            </router-link>
        </div>
