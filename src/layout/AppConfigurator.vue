...
const primaryColors = ref([
    { name: 'noir', palette: {} },
    { name: 'emerald', palette: { 50: '#f1f4f8', 100: '#d4dfeb', 200: '#b7c9dd', 300: '#9ab3d0', 400: '#7d9ec2', 500: '#6088b4', 600: '#4b739f', 700: '#3d5e82', 800: '#2f4965', 900: '#223448', 950: '#141f2b' } },
...
function onPresetChange() {
    ...
    $t().preset(presetValue).preset(getPresetExt()).surfacePalette(surfacePalette).use({ useDefaultOptions: false });
}
